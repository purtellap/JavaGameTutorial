...
public class Terrain {
    ...
    public float getHeightOfTerrain(float worldX, float worldZ){
        ...
        //System.out.println(terrainX);
        //System.out.println(terrainZ);
    ...
    private Vector3f calculateNormal(int x, int y, BufferedImage image){
        ...
        // Calculates the normal using surrounding vertices. Can and should be optimized if using randomly generated terrain.
        ...
        // potentially multiply y value by grid size
